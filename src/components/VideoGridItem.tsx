...
// formatter video
const VIEW_FORMATTER = new Intl.NumberFormat(undefined, { notation: "compact" }); // memformat seperti contoh angka (1,000 mungkin diformat sebagai "1K")

// fragment element grid item video
